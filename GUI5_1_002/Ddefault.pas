...
begin
  ...
  // Subcatch parameters
  1: begin
       for J := SUBCATCH_AREA_INDEX to SUBCATCH_PCTZERO_INDEX do
         PropList[I].Add(Project.DefProp[SUBCATCH].Data[J]);
...
begin
  ...
  for J := 0 to 8 do
  begin
    Project.DefProp[SUBCATCH].Data[SUBCATCH_AREA_INDEX + J] := PropList[1].Strings[J];
  end;
  ...
  Project.DefProp[STORAGE].Data[STORAGE_PONDED_AREA_INDEX] := PropList[2].Strings[2];
...
begin
  ...
  try
    ...
    InfilForm.SetData(TmpInfil, True);
