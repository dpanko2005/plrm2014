...
begin
  ...
  try
    ...
    begin
      ...
      with Project.Options do
      begin
        if SameText(Data[INFILTRATION_INDEX], InfilOptions[0])
        then CopyStringArray(DefHortonInfil, TmpInfil)
        else if SameText(Data[INFILTRATION_INDEX], InfilOptions[1])
        then CopyStringArray(DefGreenAmptInfil, TmpInfil)
        else if SameText(Data[INFILTRATION_INDEX], InfilOptions[2])
