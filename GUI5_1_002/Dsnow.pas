...
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Col := I;
          SetFocus;
          MessageDlg(PackProps[J] + TXT_NOT_NEGATIVE, mtError,[mbOK],0);
          Result := False;
          Exit;
        end;
      end;
      ...
      begin
        ...
        Col := I;
        SetFocus;
        MessageDlg(PackProps[1] + TXT_NOT_GREATER + PackProps[2], mtError,
          [mbOK], 0);
        Result := False;
        Exit;
      end;
      ...
      begin
        ...
        Col := I;
        SetFocus;
        MessageDlg(PackProps[4] + TXT_NOT_GREATER + '1.0', mtError,
          [mbOK], 0);
        Result := False;
        Exit;
      end;
  ...
  begin
    ...
    MessageDlg(MSG_INVALID_PLOWABLE_FRAC, mtError, [mbOK], 0);
    Result := False;
    Exit;
  end;
  ...
  begin
    ...
    MessageDlg(MSG_NO_SUBCATCH_NAME, mtError, [mbOK], 0);
    Result := False;
    Exit;
  end;
  ...
  begin
    PageControl1.ActivePageIndex := 1;
    NumEdit1.SetFocus;
    MessageDlg(MSG_INVALID_REMOVALS, mtError, [mbOK], 0);
    Result := False;
    Exit;
  end;
end;
