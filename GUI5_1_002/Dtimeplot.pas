...
uses
  ...
  Fgraph, Uglobals, Uproject, Vcl.ComCtrls;
...
begin
  ...
  begin
    MessageDlg(MSG_NO_SUCH_OBJECT, mtError, [mbOK], 0);
    Exit;
  end;
  ...
  if SeriesIndex >= SeriesListBox.Items.Count
  then SeriesListBox.Items.Add(S)
  else SeriesListBox.Items[SeriesIndex] := S;
...
begin
  ...
  begin
    ...
    BtnMoveUp.Enabled := Items.Count > 1;
    BtnMoveDown.Enabled := Items.Count > 1;
  end;
end;
