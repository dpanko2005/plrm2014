...
// Passes the string value S of property index Index to the ValidateInput
// function in the Uedit.pas unit.
//-----------------------------------------------------------------------------
begin
...
begin
  ...
  then Uedit.EditInfiltration(Project.CurrentItem[CurrentList], Modified)
  ...
  else if (CurrentList = STORAGE) and (Index = STORAGE_ATABLE_INDEX)
  then EditCurve(STORAGECURVE, S)

////  DEPRECATED  ////                                                          //(5.0.023 - LR)
//// User wants to edit a Storage Unit's infiltration parameters                //(5.0.023 - LR)
//else if (CurrentList = STORAGE) and (index = STORAGE_INFIL_INDEX)             //(5.0.023 - LR)
//then Uedit.EditStorageInfil(Project.CurrentItem[CurrentList], S, Modified)    //(5.0.023 - LR)
