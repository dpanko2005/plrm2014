...
begin
  ...
  FindFileBtn.Enabled := not IsChecked;
...
begin
  ...
  begin
    MessageDlg(MSG_NO_FILE, mtError, [mbOK], 0);
    ...
    begin
      ...
      try
        ...
        begin
          ...
          Col := 1;
          Result := False;
          MessageDlg(MSG_OUT_OF_ORDER, mtError, [mbOK], 0);
          break;
        end;
      ...
      try
        ...
        begin
          Result := False;
          MessageDlg(MSG_ILLEGAL_NUMBER, mtError, [mbOK], 0);
          Row := I;
          Col := 2;
          break;
        end;
