...
begin
  ...
  begin
    ...
    OrificeHint[ORIFICE_BOTTOM_HT_INDEX] :=
      'Elevation of bottom of orifice opening' + DEFAULT_OFFSET_TXT2;
    WeirHint[WEIR_CREST_INDEX] :=
      'Elevation of bottom of weir opening' + DEFAULT_OFFSET_TXT2;
...
begin
  ...
  begin
    ...
    begin
      if MessageDlg(Msg1, mtConfirmation, [mbYes, mbNo], 0) = mrYes
  ...
  begin
    if Project.GetLinkCount > 0 then
    begin
      if MessageDlg(Msg2, mtConfirmation, [mbYes, mbNo], 0) = mrYes
