...
type
  TProfilePlotOptionsForm = class(TForm)
    ...
    procedure MainTitleFontBtnClick(Sender: TObject);
...
procedure TProfilePlotOptionsForm.LoadOptions(theGraphOptions: TGraphOptions;
  ...
  theYtitle: String; IncludeHGL: Boolean);
//-----------------------------------------------------------------------------
...
begin
  ...
  begin
    if ColorBox1.Items[ColorBox1.ItemIndex] = 'Default'
    then PanelColor := -1
...
begin
  ...
  begin
    ...
    YincExt := StrToFloatDef(YincEdit.Text, Increment);
...
procedure TProfilePlotOptionsForm.MainTitleFontBtnClick(Sender: TObject);
//-----------------------------------------------------------------------------
//  OnClick handler for the font button used to change the font properties
//  of the main title displayed on the profile plot.
//-----------------------------------------------------------------------------
begin
  with FontDialog do
  begin
...
procedure TProfilePlotOptionsForm.AxisFontBtnClick(Sender: TObject);
//-----------------------------------------------------------------------------
//  OnClick handler for the font button used to change the font properties
