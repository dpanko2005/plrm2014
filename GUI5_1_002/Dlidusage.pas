...
begin
  ...
  Data[7] := ExtractFileName(RptFileName);
  Data[8] := ExtractFilePath(RptFileName);
end;
...
var
  ...
  Pclient: TPoint;
begin
  // Get coordinates of middle left of edit control
  Pclient.X := 0;
  Pclient.Y := Height div 2;
  ...
  begin
    ...
    begin
      ...
      MessageDlgPos('LID Control cannot be left blank.', mtError, [mbOK],
  ...
  begin
    Pscreen := ClientToScreen(Pclient);
    MessageDlgPos('LID area exceeds subcatchment area',
