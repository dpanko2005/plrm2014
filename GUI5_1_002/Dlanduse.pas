...
begin
  ...
  begin
    ...
    ValueColor := clNavy;
    HeadBackColor := RGB(191,205,219);  //clInactiveCaption;  //clGray;
    HeadForeColor := clBlack;  //clWhite;
...
begin
  ...
  begin
    ...
    begin
      MessageDlg(MSG_NAME_EXISTS, mtError, [mbOK], 0);
      Err := True;
    end;
  end;
  if Err = True then
